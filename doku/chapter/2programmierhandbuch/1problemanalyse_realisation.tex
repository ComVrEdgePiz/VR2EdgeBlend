...
\item Die Dock-Bars (z.B. der Taskbar) von Gnome wird an den unteren Rand der neuen Workarea verschoben.
\end{itemize}
...
Die Abbildung 3.1 veranschautlicht die hier besprochenen Schritte.
